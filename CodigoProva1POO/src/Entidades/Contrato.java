...
public class Contrato {
	...
	public void calculacorretagem(double precoI) {
		if(ano >= 2022 || precoI >= 1000000) {
			valorcorretagem = precoI * 0.05;
		}
		else valorcorretagem = precoI * 0.1;
	}
	
	
	public Contrato(int numeroC, int ano, int numeroI, double preco, String nome1, String nome2, int idade1, int idade2) {
		numero = numeroC;
		this.ano = ano;
	...
	public Contrato(int numeroC, int numeroI, double preco, String nome1, String nome2, int idade1, int idade2) {
		numero = numeroC;
		this.ano = 2024;
		calculacorretagem(preco);
		i = new Imovel(numeroI, preco, nome1, nome2, idade1, idade2);
